 ...
 * @author Piot Kordy
 */
public class BoolAndOr implements Domain<Bool>
{
  //number 3
  static final long serialVersionUID = 368474778914366456L;
  /**
  ...
  {
    return "Satisfiability for the opponent";
  }
  ...
  {
    final String name = "Satisfiability for the opponent, assuming that all"
      + " proponent's actions are in place";
    final String vd = "{true,&nbsp;false}";
    final String[] operators = {"<i>x</i>&nbsp;&and;&nbsp;<i>y</i>",
                           "<i>x</i>&nbsp;&or;&nbsp;<i>y</i>",
                           "<i>x</i>&nbsp;&or;&nbsp;<i>y</i>",
                           "<i>x</i>&nbsp;&and;&nbsp;<i>y</i>",
                           "<i>x</i>&nbsp;&or;&nbsp;<i>y</i>",
