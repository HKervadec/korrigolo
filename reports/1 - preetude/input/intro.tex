\section{Introduction}
    ...
    De plus la concentration de la population dans les transports implique un dommage humain conséquent en cas d'attaque létale. % Un peu violent des le debut
    ...
    % Les objectifs devraient etre beaucoup plus clairs des l'intro
    % Dvp cette partie
    % faire partie objectifs