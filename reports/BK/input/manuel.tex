...
\BK{Parfois vous écrivez Éditeur de Fonctions, parfois Éditeur de fonctions (Fonctions/fonctions). A unifier.}
...
\BK{Est-ce qu'il ne fait pas commencer par dire 
sous quel système Glasir marche. Est-ce qu'il faut avoir un environnement/programmes spécifiques.
Comment lancé l'outil? Je commencerais par dire que Glasir est fourni sous forme .exe}
...
Pour utiliser l'Éditeur de onctions, \BK{il manque 'F'} suivez les étapes suivantes : 
...
\BK{C'est dommage qu'il n'y a pas de screen shot (Glasir + fenêtre d'ADTool) du résultat obtenu après avoir utilisé l’Éditeur de Fonctions.}

\BK{A votre place, j'illustrerais le fonctionnement d’éditeur, de filtre et d'optimiseur 
sur un même arbre.}
...
\BK{C'est dommage qu'il n'y a pas de screen shot (Glasir + fenêtre d'ADTool) du résultat obtenu après avoir utilisé le Filtre sur le même arbre que précédemment.}
...
\BK{C'est dommage qu'il n'y a pas de screen shot (Glasir + fenêtre d'ADTool) du résultat obtenu après avoir utilisé l'Optimiseur}
...
\BK{\cite{ADTool_Manual}} disponible sur Internet\footnote{Voir à l'adresse suivante : http://satoss.uni.lu/members/piotr/adtool/manual.pdf}. Le guide ici présent ne détaillera que l'utilisation des nouvelles fonctionnalités d'ADTool, qui sont le copier/couper/coller ainsi que l'annulation d'une action.
