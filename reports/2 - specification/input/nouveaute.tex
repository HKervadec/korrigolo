...
filtre(racine, rules) :
	...
	\subsection{Optimiseur}
		...
		\subsubsection{Algorithmique}
			Nous allons maintenant détailler l'algorithme qui parcourra l'arbre afin d'en extraire le meilleur. % PK FAIRE ?
