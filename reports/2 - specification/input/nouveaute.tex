\section{Fonctions d'analyse}
	...
	\subsection{Filtre}
		...
		L'algorithme utilisé est l'Algorithme \ref{algo:filtre}. 
		\begin{algorithm}[h!]
		...
		\subsection{Paramètres de synthèse}
			...
			Cette nouvelle fonctionnalité, appelée \emph{éditeur de paramètres}, prendra donc en entrée les éléments suivants :
			\begin{itemize}
