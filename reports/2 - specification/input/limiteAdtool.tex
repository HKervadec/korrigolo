\section{ADTool : étude de l'existant}
	...
	À l'issue de cette étude d'ADTool, certaines limitations ont été mises en avant car elles rendent l'analyse des arbres édités laborieuse. Comme l'objectif de notre projet est de simplifier ce travail pour un expert en sécurité, nous avons cherché à implémenter des solutions pour combler les lacunes évoquées.