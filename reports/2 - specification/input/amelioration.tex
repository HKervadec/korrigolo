\section{Ergonomie du logiciel}
	...
	\subsection{Bibliothèque de modèles}
		...
		Notre étude portant sur le réseau STAR, la bibliothèque de modèle générique intégrera principalement des ADTrees relatifs aux réseaux de transport en commun rennais. 
