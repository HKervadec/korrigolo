...
//       return new BoundedInteger(BoundedInteger.INF,bound);
  ...
  */
  ...
  {
    final String name = "Minimal skill  level needed for the proponent,"
      + " assuming that all opponent's actions are in place and that the set of "
      + " skill levels is linearly ordered";
